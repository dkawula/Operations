#Updated Version of the Hyper-V Reporting Script to work with Windows Server 2016
#We use this as a daily coffee report for all of our customers
#Dave Kawula MVP
...
<#
	.SYNOPSIS
		...
		Version History:
            ...
            [x] Version 1.6 - 25.April.2017 (add sender name parameter and for windows 2016)
    ...
    .PARAMETER SenderName
		...
		Mail sender user name for SMTP authentication.
...
<html>
<head>
<title>GDM - Admin Hyper-V Environment Report</title>
<br>
...
<body>
<br><br>
<center><h1>GDM - Hyper-V Environment Report</h1></center>
<br>
<center><h1>GDM S2D Cluster</h1></center>
...
if ($SendMail -or $SMTPServer)
{
    if ($SMTPServer -and $MailFrom -and $MailTo)
    {
        ...
        if ($MailFromPassword)
        {
            ...
            $smtp.Credentials = New-Object System.Net.NetworkCredential($SenderName, $MailFromPassword)
        }
