...
$imageId = "/subscriptions/<InsertSub>/resourceGroups/<ResourceGroup>/providers/Microsoft.Compute/galleries/HoLGallery/images/TechmentorOrlando2024-HOL2/versions/2.1.0"
$sku = "Standard_D8s_v3" 
$vmPrefix = "Student"
