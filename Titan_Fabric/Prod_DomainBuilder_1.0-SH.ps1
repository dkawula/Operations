...
Invoke-FabricVMPrep 'HACA1-DC01' 'HACA1-DC01' -FullServer2019
Invoke-FabricVmPrep 'HACA1-DC02' 'HACA1-DC02' -FullServer2019
Invoke-FabricVmPrep 'HACA1-MGMT01' 'HACA1-MGMT01' -FullServer2019
Invoke-FabricVmPrep 'HACA1-OFFC-A' 'HACA1-OFFC-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-OFFC-B' 'HACA1-OFFC-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-REQU-A' 'HACA1-REQU-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-REQU-B' 'HACA1-REQU-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-RESP-A' 'HACA1-RESP-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-RESP-B' 'HACA1-RESP-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-EVAL-A' 'HACA1-EVAL-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-EVAL-B' 'HACA1-EVAL-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-COMM-A' 'HACA1-COMM-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-COMM-B' 'HACA1-COMM-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-REPT-A' 'HACA1-REPT-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-REPT-B' 'HACA1-REPT-B' -FullServer2019
Invoke-FabricVmPrep 'HACA1-SQLSVR-A' 'HACA1-SQLSVR-A' -FullServer2019
Invoke-FabricVmPrep 'HACA1-SQLSVR-B' 'HACA1-SQLSVR-B' -FullServer2019
...
write-Output -InputObject "[$($VMName)]:: Working on Production Post-Configuration Settings"
Invoke-Command -VMName $VMName -Credential $domainCred {
 # Enable Remote Desktop

 write-Output -InputObject "[$($VMName)]:: Enable Remote Desktop Firewall Rule"
    ...
    write-Output -InputObject "[$($VMName)]:: Enable Ping through Windows Firewall"

    Enable-NetFirewallRule -Name 'FPS-ICMP4-ERQ-In'

    #Configure Automatic Update to not download Drivers

    write-Output -InputObject "[$($VMName)]:: Configure Windows Update Settings"
    ...
    write-Output -InputObject "[$($VMName)]:: Configure Crash Dump Settings"
    ...
    #Get Rid of Unattend.txt

    write-Output -InputObject "[$($VMName)]:: Remove Unattend.txt file"
...
Invoke-Command -VMName $VMName -Credential $localCred {
    ...
    $null = Get-Netroute | Where-Object DestinationPrefix -eq "0.0.0.0/0" | Remove-NetRoute -Confirm:$False
    $null = Test-NetConnection localhost
    $null = Set-DnsClientServerAddress -InterfaceAlias "Ethernet" -ServerAddresses ("172.16.16.100","172.16.16.101") -Verbose
    new-netroute -InterfaceAlias "Ethernet" -NextHop $newroute  -DestinationPrefix '0.0.0.0/0' -verbose
...
$VMName = 'HACA1-SQLSVR-A'
$GuestOSName = 'HACA1-SQLSVR-A'
$IPNumber = '117'
...
$VMName = 'HACA1-SQLSVR-B'
$GuestOSName = 'HACA1-SQLSVR-B'
$IPNumber = '118'
