...
.NOTES  FULL CREDIT Here --> I just modified the Mailto Functions
    ...
    3.0.0 Dave Kawula - MVP - Modified with new Sendgrid Mailto 
...
BEGIN
{
	TRY
	{
		...
		Start-Transcript -Path C:\Post-Install\005-MonitorADG\Output\MonitorADG-Transcript.log
				...
				IF ($GroupName)
				{
					...
					If ($Changes)
					{
						...
						#$Body
                            ...
                            $EmailFrom = "MonitorADG-Operations-No-Reply@checkyourlogs.net"

                            #$EmailTo = "helpdesk@triconelite.com"
...
<#>
                        ...
                        $Creds = New-Object -TypeName System.Net.NetworkCredential("apikey","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")
